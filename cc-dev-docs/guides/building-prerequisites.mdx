...
1. **Understand the Data Model** - Review [Data Model Overview](/references/data-model-overview)
2. **Learn Access Patterns** - Check [Creator & Collab Data Model](/references/creator-collab-data-model)
3. **Start Building** - Follow [Build with CreatorCommerce](/guides/getting-started)

## Related Documentation

- [Build with CreatorCommerce](/guides/getting-started) - Platform overview
- [How to Use These Docs](/guides/how-to-use-these-docs) - Working effectively with AI and canonical references
- [Documentation Contract](/guides/documentation-contract) - Where canonical facts live
- [The 3 M's](/guides/the-3-ms) - Strategic orientation
- [Data Model Overview](/references/data-model-overview) - Understanding the architecture
