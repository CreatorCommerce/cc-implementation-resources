...
Product forms usually render inside a collection form after a creator adds products. Use them for data that belongs to one product in the curated collection, such as a review, rating, UGC upload, sizing note, usage tip, or "why I love this" quote.
