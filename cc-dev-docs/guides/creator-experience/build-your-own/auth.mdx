---
title: 'Authenticate a Custom Creator Dashboard'
description: 'Authentication patterns for creator dashboards built in Shopify customer-account experiences and backend proxies.'
pageType: 'How-to'
---
