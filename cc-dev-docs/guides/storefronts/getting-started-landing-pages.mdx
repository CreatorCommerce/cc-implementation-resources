...
- **Automatic URL generation** — Each creator gets `/pages/creator/[handle]`
...
Use prebuilt CC sections in Theme Editor:
...
Best when you want to launch quickly and keep everything editable in Theme Editor.
...
<Steps>
  ...
  <Step title="Bootstrap from homepage sections (code-first quick win)">
  ...
  <Step title="Add CC sections to the template">
    ...
    See [App Blocks 101](/guides/storefronts/app-blocks-101) and [Quick Start: Out-of-the-Box Blocks](/guides/storefronts/quick-start-out-of-box-blocks) for section-by-section references.
  </Step>
  <Step title="Preview the page">
    Visit `/pages/creator/[creator-handle]` to see the live page. In the theme editor, you can preview by selecting any creator entry from the metaobject picker.
  </Step>
</Steps>
...
2. **Live preview** — Visit `/pages/creator/[handle]` directly
...
<CardGroup cols={2}>
  <Card title="App Blocks 101" icon="blocks" href="/guides/storefronts/app-blocks-101">
