...
<Tip>
**New to CreatorCommerce?** Start with the [Quick Start: Out-of-the-Box Blocks](/guides/storefronts/quick-start-out-of-box-blocks) guide to get live in under an hour using pre-built sections. This guide covers custom builds with full code control.
</Tip>
