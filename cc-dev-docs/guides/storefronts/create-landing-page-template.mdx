...
| URL | Template Used |
|-----|---------------|
| `/pages/creator/sarah-jones` | `creator.json` (default) |
| `/pages/creator/sarah-jones?view=summer-campaign` | `creator.summer-campaign.json` |
| `/pages/creator/sarah-jones?view=minimal` | `creator.minimal.json` |
