---
title: 'Implement Co-branded Pop-ups'
description: 'Implementation patterns for creator-aware pop-ups, suppression rules, and attributed email capture.'
pageType: 'How-to'
---

<Info>
Page type: `How-to`. For the capability overview, see [Co-branded Pop-ups](/guides/features/co-branded-popups).
</Info>
...
if (popupKey && !sessionStorage.getItem(popupKey)) {
  const isCreatorLandingPage = window.location.pathname.includes('/pages/creator/');
