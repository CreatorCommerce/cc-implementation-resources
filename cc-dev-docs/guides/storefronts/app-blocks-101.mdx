---
title: 'Use CC Sections in Theme Editor'
description: 'Add CreatorCommerce storefront components in Theme Editor and understand when CC uses sections and snippets instead of native Shopify app blocks.'
pageType: 'How-to'
---

<Info>
Page type: `How-to`. CreatorCommerce storefront components are primarily delivered as Liquid sections and snippets, not standard Shopify app blocks.
</Info>
