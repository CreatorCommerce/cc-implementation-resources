...
<Steps>
  <Step title="Connect Klaviyo integration">
    In CreatorCommerce, add your Klaviyo API key and verify the integration is connected.
  </Step>
...
## Getting CreatorCommerce Help

To have CreatorCommerce assemble the base Klaviyo emails and flows, email [help@creatorcommerce.shop](mailto:help@creatorcommerce.shop). Invite [team@creatorcommerce.shop](mailto:team@creatorcommerce.shop) to Klaviyo as a **manager** so the team can configure templates and flows in your account.
