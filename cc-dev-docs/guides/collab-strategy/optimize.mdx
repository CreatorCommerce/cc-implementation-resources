---
title: 'Testing & Retention Strategies'
...
<Checklist>
  ...
  - [ ] [Custom forms](/guides/creator-experience/forms/overview) configured for structured data collection (onboarding, collection, product, and custom forms)
  - [ ] [Custom fields](/references/custom-fields-reference) defined for segment-specific data (specialties, testimonials, product notes)
</Checklist>
