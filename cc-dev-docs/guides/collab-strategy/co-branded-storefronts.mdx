---
title: 'Designing Storefronts by Persona'
...
<Tabs>
  ...
  <Tab title="Partner Customizations">
    **What it includes:**
    ...
    - [Custom field data](/references/custom-fields-reference) — specialty, testimonials, product notes, and any segment-specific data collected via [forms](/guides/creator-experience/forms/overview)
    
    **How it works:**
    - Data from CreatorCommerce metaobjects (including custom fields)
    - Partner can edit via dashboard or submit updates through forms
    - Renders within segment template using Liquid access patterns
  </Tab>
</Tabs>
...
<Info>
At the **Premium** and **Custom** levels, [custom fields](/references/custom-fields-reference) unlock deeper personalization. For example, a practitioner's credentials and specialty, an influencer's content style preference, or product-level "why I love this" notes—all collected via [CC's form system](/guides/creator-experience/forms/overview) and displayed dynamically on the storefront.
</Info>
