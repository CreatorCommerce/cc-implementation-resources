...
<AccordionGroup>
  ...
  <Accordion title="Custom Fields for Segment-Specific Data">
    Beyond standard fields, CreatorCommerce supports [custom fields](/references/custom-fields-reference) at three levels:
    ...
    See [Planning Custom Fields](/guides/enrichment/getting-started/planning-fields) for guidance on deciding what to collect.
  </Accordion>
</AccordionGroup>
...
<Tip>
CreatorCommerce's native form system supports this progressive approach out of the box. Use **onboarding forms** at enrollment for essentials, then activate **collection forms** and **product forms** as partners begin curating drops. See [Custom Forms Overview](/guides/creator-experience/forms/overview) for the full form architecture.
</Tip>
