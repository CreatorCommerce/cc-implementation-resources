...
<AccordionGroup>
  ...
  <Accordion title="Custom Data (via Custom Fields & Forms)">
    **What:** Segment-specific data like specialties, credentials, audience demographics, product testimonials, sizing info, content preferences
    
    **Why:** Enables deeper personalization, richer storefront content, and segment-specific experiences
    
    **How to get it:**
    - [Onboarding forms](/guides/creator-experience/forms/onboarding/overview) for collab-level data at signup
    - [Collection forms](/guides/creator-experience/forms/collection/overview) for drop-level data during curation
    - [Product forms](/guides/creator-experience/forms/product/overview) for product-level data within drops
    - [Custom forms](/guides/creator-experience/forms/custom/overview) for ongoing or campaign-specific collection
    
    All form data maps to [custom fields](/references/custom-fields-reference) that are immediately available for storefront rendering.
  </Accordion>
</AccordionGroup>
...
<Tabs>
  <Tab title="Forms">
    ...
    **Implementation:**
    ...
    Each form type maps to [custom fields](/references/custom-fields-reference) at the appropriate level (collab, drop, or product), so the data collected is automatically available in Liquid templates on the storefront.
