---
title: 'Going Live & Measuring Success'
...
<Steps>
  ...
  <Step title="Generate CC Links">
    Each partner gets a co-branded URL (e.g., `/pages/creator/partner-handle`)
  </Step>
...
<Tabs>
  <Tab title="Direct CC Links">
    **Format:** `yourstore.com/pages/creator/partner-handle`
