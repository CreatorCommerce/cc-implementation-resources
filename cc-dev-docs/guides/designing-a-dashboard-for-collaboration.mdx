...
description: 'Design principles for CreatorCommerce dashboard experiences, including hosted-dashboard customization and custom build considerations.'
pageType: 'How-to'
---

<Info>
Page type: `Overview`. For implementation paths, pair this page with [Creator Dashboard](/guides/creator-dashboard) and the build-your-own dashboard guides.
</Info>
...
- [Creator Dashboard](/guides/creator-dashboard)
