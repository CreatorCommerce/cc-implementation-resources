...
description: 'Design principles for co-branded storefront interfaces, with links to canonical storefront vocabulary and implementation references.'
pageType: 'How-to'
---

<Info>
Page type: `Overview`. Use this page for design direction, then use the storefront glossary and implementation guides for concrete patterns.
</Info>
