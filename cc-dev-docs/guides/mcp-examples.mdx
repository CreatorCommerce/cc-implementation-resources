...
<AccordionGroup>
  ...
  <Accordion title="Merchant discovery prep">
    ```text
    I have a sales call with a DTC skincare brand that does $2M/year
    and has 50 affiliates. Help me run a discovery framework and
    build a tailored CreatorCommerce presentation for them.
    ```
  </Accordion>
</AccordionGroup>
