...
- The cart attributes set here are reused by [Shopify-native Attribution](/guides/features/shopify-native-attribution), post-purchase tagging, and reporting.
- Discount persistence should be implemented with [Maintained Discount Protection](/guides/features/maintained-discount-protection) so attribution and customer UX stay intact across sessions.
