...
- It works in tandem with [Co-branded Carts & Checkout](/guides/features/co-branded-carts-checkout) and [Shopify-native Attribution](/guides/features/shopify-native-attribution) by preserving creator context through conversion.
