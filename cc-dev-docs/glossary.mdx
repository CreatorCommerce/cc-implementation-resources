...
### Channel
A brand or merchant that collaborates with creators. The channel represents the Shopify store that creators promote.
...
A relationship between a creator and a channel. Each collab represents a creator's partnership with a specific brand, including their tier, discount codes, and drops.
...
### Collab Tier
A classification level for a collaboration (e.g., "Ambassadors", "Influencers", "Partners"). Defines the relationship type and may have associated campaigns.
...
### Drop
A curated collection of products recommended by a creator. Drops can include product enhancements (notes, media) and custom fields.
