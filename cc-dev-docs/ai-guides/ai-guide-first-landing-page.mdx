...
|---|----------|--------|-------|
| 1 | Do you have CreatorCommerce installed on your Shopify store? | Continue | Direct to [Building Prerequisites](/guides/building-prerequisites) |
...
|---------|-------------|-------------|
| **A: Dedicated Creator Page** | Each creator gets their own URL (e.g., `/pages/creator/sarah-jones`) | Most common. Best for SEO, sharing, and a fully personalized experience. |
...
In Shopify admin: **Settings → Custom data → Metaobjects → Creator → Web template**. Enable "Generate pages" for the creator metaobject. This creates a page for each creator at `/pages/creator/[handle]`.
...
**Custom fields beyond the base metaobject:** Brands may have additional custom fields populated through CC forms (onboarding, custom, collection, or product forms). These are stored at three levels:
...
- [Building Prerequisites](/guides/building-prerequisites) — Setup requirements and verification checklist
...
- [Referencing Creator Content](/references/sdk/referencing-creator-content) — Cart attribute resolution and field access patterns
- [Drops & Products Data Model](/references/drops-products-data-model) — **Read this** if they need to display product lists
- [Custom Fields Reference](/references/custom-fields-reference) — Product-level enhancement fields and custom creator data
...
- [AI Use Case: Theme Edits](/ai-guides/ai-theme-edits) — **Hand off here** for specific section edits like adding dynamic text or converting sections
