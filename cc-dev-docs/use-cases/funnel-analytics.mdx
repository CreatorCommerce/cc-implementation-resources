...
<Info>
Session-driven data in the CreatorCommerce dashboard is delayed by 24 hours. If you check the dashboard at 2pm ET, it reflects the state through 2pm ET the previous day. For real-time reporting, use Shopify reports and Shopify Analytics.
</Info>
