...
<Tip>
Place these two `assign` lines at the top of any section or snippet that needs creator context. They're safe to call everywhere — if no creator is present, `cc_creator` will be `nil` and the conditional blocks won't render.
</Tip>
