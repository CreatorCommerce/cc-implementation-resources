...
### Social Handles (Channel-Dependent)

Some CreatorCommerce installs expose additional social handle fields when they have been mapped into the creator record. Treat these as optional fields and confirm availability in your channel before building storefront logic around them.
