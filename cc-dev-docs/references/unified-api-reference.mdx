...
description: 'Canonical entry point for generated Unified API endpoint documentation and related API reference guides.'
...
<Info>
Page type: `Reference`. The OpenAPI file is the source of truth for endpoint shapes and request/response details.
</Info>
...
<CardGroup cols={2}>
  <Card title="API Overview" icon="book" href="/references/api-overview">
    Capability map, mental model, and API surface overview
  </Card>
