...
- [Creator & Collab Data Model](/references/creator-collab-data-model) - Collab structures
- [Drops & Products Data Model](/references/drops-products-data-model) - Drop structures
- [Shopify Integration Data Model](/references/shopify-integration-data-model) - Metaobject fields
