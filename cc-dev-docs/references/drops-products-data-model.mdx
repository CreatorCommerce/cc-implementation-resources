...
Enhancements are product content fields within a drop within a collab within a channel. They contain the personalized content that creators add to products.
...
- [Data Model Overview](/references/data-model-overview) - High-level architecture
- [Creator & Collab Data Model](/references/creator-collab-data-model) - Creator structures
- [Shopify Integration Data Model](/references/shopify-integration-data-model) - Collections
- [Custom Fields Reference](/references/custom-fields-reference) - Custom field patterns
