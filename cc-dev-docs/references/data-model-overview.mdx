...
- [Creator & Collab Data Model](/references/creator-collab-data-model) - Deep dive into creator/collab structures
- [Drops & Products Data Model](/references/drops-products-data-model) - Drops and products architecture
- [Shopify Integration Data Model](/references/shopify-integration-data-model) - Metaobjects and collections
- [Custom Fields Reference](/references/custom-fields-reference) - Field configuration and access patterns
