...
<Info>
**Before creating collabs:** Complete your [initial settings configuration](/guides/initial-settings) to set up brand kit values, creator settings, onboarding configuration, and discount preferences. These settings establish defaults that apply across all creator partnerships.
</Info>
