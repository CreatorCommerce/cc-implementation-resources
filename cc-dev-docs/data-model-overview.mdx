...
### Channel
The brand or merchant that collaborates with creators. Represents a Shopify store.
...
### Collab Tier
A classification level for collaborations (e.g., "Ambassadors", "Influencers").

**Key Relationships:**
- Belongs to one or more Campaigns
- Contains many Collabs
- Defines relationship type and permissions

### Collab (Collaboration)
The core relationship between a Creator and a Channel.
...
### Drop
A curated collection of products recommended by a creator.
...
### Product Enhancement
Additional content created by a creator for a specific product in a drop.
